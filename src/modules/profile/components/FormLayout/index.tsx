...
const FormLayout: React.FC = ({ children }) => {
  ...
  return (
    <div className={styles.wrapper}>
      ...
      <Button onClick={onProviderClick} className={styles.button} theme="secondary" text="Продолжить через Google" icon="google" />
      <Button onClick={onProviderClick} className={styles.button} theme="secondary" text="Продолжить через VK" icon="vk" />
    </div>
  );
};
